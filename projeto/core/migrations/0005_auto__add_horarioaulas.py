...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'HorarioAulas'
        db.create_table(u'core_horarioaulas', (
        ...
        db.send_create_signal(u'core', ['HorarioAulas'])


    def backwards(self, orm):
        # Deleting model 'HorarioAulas'
        db.delete_table(u'core_horarioaulas')
