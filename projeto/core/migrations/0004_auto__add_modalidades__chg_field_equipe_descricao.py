...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Modalidades'
        db.create_table(u'core_modalidades', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('imagem', self.gf('cloudinary.models.CloudinaryField')(max_length=100, null=True, blank=True)),
            ('modalidade', self.gf('django.db.models.fields.CharField')(max_length=100)),
        ...
        db.send_create_signal(u'core', ['Modalidades'])


        # Changing field 'Equipe.descricao'
        db.alter_column(u'core_equipe', 'descricao', self.gf('django.db.models.fields.TextField')())

    def backwards(self, orm):
        # Deleting model 'Modalidades'
        db.delete_table(u'core_modalidades')


        # Changing field 'Equipe.descricao'
        db.alter_column(u'core_equipe', 'descricao', self.gf('tinymce.models.HTMLField')())
