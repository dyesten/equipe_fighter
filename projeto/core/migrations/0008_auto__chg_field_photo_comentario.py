...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Photo.comentario'
        db.alter_column(u'core_photo', 'comentario', self.gf('django.db.models.fields.TextField')(null=True))

    def backwards(self, orm):

        # Changing field 'Photo.comentario'
        db.alter_column(u'core_photo', 'comentario', self.gf('django.db.models.fields.CharField')(max_length=250, null=True))
